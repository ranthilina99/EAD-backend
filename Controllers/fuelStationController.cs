...
namespace MongoExample.Controllers
{
    ...
    public class FuelStationController : Controller
    {
        ...
        //get fuel stations according to city
        [HttpGet("GetStationOwnerId")]
        public async Task<List<FuelStation>> GetFuelDetailsOwnerId(string ownerId)
        {
            return await _mongoDBService.GetStationOwnerId(ownerId);
        }
