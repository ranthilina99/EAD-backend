...
namespace MongoExample.Services {
    ...
    public class MongoDBService
    {
        ...
        public async Task<List<FuelStation>> GetStationOwnerId(string ownerId)
        {
            FilterDefinition<FuelStation> filter = Builders<FuelStation>.Filter.Eq("UserId", ownerId);
            return await _fuelStationCollection.Find(filter).ToListAsync();
        ...
        public async Task<List<Queue>> FetchQueueCustomer(string id)
        {
            FilterDefinition<Queue> filter = Builders<Queue>.Filter.Eq("UserId", id);
            return await _queueCollection.Find(filter).ToListAsync();
